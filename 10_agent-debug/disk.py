...
if platform.system() == 'Windows':
    ...
    def _base_device_name(device):
        ...
        # instances:
        #   device_tag_re: 
        #       "/dev/vda1": "disk_label:test-disk-dev-vda"
        #       "vda": "disk_label:test-disk-vda"
        #       "vda1": "disk_label:test-disk-vda1"
        # 
        # The above returns:
        # {'use_mount': False}
        # Which is the default setting, so that means the instances config is completely ignored
        #
        # However with the following it works:
        # instances:
        #   - use_mount: false
        #     device_tag_re: 
        #       /dev/vda1: "disk_label:test-disk-dev-vda"
        ...
        #       vda1: "disk_label:test-disk-vda1"
        #
        #  {'device_tag_re': {'/dev/vda1': 'disk_label:test-disk-dev-vda', 'vda': 'disk_label:test-disk-vda', 'vda1': 'disk_label:test-disk-vda1'}, 'use_mount': False}
        #
...
class Disk(AgentCheck):
    ...
    def __init__(self, name, init_config, instances):
        ...
        # Testing
        self.log.warning('HERE! instance')
        self.log.warning(instance)
    ...
    def _compile_tag_re(self):
        ...
        """
        device_tag_list = []
        self.log.warning('HERE!! self._device_tag_re')
        self.log.warning(self._device_tag_re) # Returns an empty dict {}
